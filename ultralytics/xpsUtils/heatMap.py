...
def get_params():
    params = {
        'weight': r'D:\learningJournal\Detection\YOLO\ultralytics-main\xpsUtils\fasterNet_Neck3CUT_BiFPN_PSA_CPF2D2_2003\weights\best.pt',  # 训练出来的权重文件
        ...
        'cfg': 'ultralytics/cfg/models/v8/fasterNet_Neck3CUT_BiFPN_PSA_CPF2D2.yaml',  # 训练权重对应的yaml配置文件
        # ultralytics/cfg/models/v8/yolov8.yaml
        # ultralytics/cfg/models/v8/fasterNet_Neck3CUT_BiFPN_PSA_CPF2D2.yaml
        'device': 'cuda:0',
        'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM , 使用的热力图库文件不同的效果不一样可以多尝试
        'layer': 'model.model[13]',  # 想要检测的对应层[7, 13], [9, 15]
...
if __name__ == '__main__':
    ...
    # 循环处理 heatMap 目录中的所有图片
    heatmap_dir = r'D:\Dataset\VisDrone2019-DET\test\images\a\heatMap\9999979_00000_d_0000022.jpg'
    save_dir = r'D:\Dataset\VisDrone2019-DET\test\images\a\FBI_result\FBI13_9999979_00000_d_0000022_result'

    model(heatmap_dir, save_dir)
    # for img_name in os.listdir(heatmap_dir):
    #     img_path = os.path.join(heatmap_dir, img_name)
    #     if img_name.lower().endswith(('.png', '.jpg', '.jpeg')):  # 只处理图片文件
